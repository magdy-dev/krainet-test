package com.krainet.notificationservice.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.krainet.notificationservice.controller..*(..)) || " +
            "execution(* com.krainet.notificationservice.service..*(..))")
